...
namespace InspireMe.Identitiy
{
        ...
        where TUserToken : IdentityUserToken<TKey>, new()
    {
        ...
        public UsersTable(IDatabaseConnectionFactory dbConnectionFactory) : base(dbConnectionFactory) { }
        ...
        public virtual async Task<bool> UpdateAsync(TUser user, IList<TUserClaim> claims, IList<TUserRole> roles, IList<TUserLogin> logins, IList<TUserToken> tokens) {
            ...
            using (var transaction = DbConnection.BeginTransaction()) {
                ...
                if (claims?.Count() > 0) {
                    ...
                    const string insertClaimsSql = "INSERT INTO AspNetUserClaims (UserId, ClaimType, ClaimValue) " +
                ...
                if (roles?.Count() > 0) {
                    ...
                    const string insertRolesSql = "INSERT INTO AspNetUserRoles (UserId, RoleId) " +
                ...
                if (logins?.Count() > 0) {
                    ...
                    const string insertLoginsSql = "INSERT INTO AspNetUserLogins (LoginProvider, ProviderKey, ProviderDisplayName, UserId) " +
                ...
                if (tokens?.Count() > 0) {
                    ...
                    const string insertTokensSql = "INSERT INTO AspNetUserTokens (UserId, LoginProvider, Name, Value) " +
