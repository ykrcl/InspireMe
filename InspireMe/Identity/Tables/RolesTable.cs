...
namespace InspireMe.Identitiy
{
        ...
        where TRoleClaim : IdentityRoleClaim<TKey>, new()
    {
        ...
        public RolesTable(IDatabaseConnectionFactory dbConnectionFactory) : base(dbConnectionFactory) { }

        /// <inheritdoc/>
        public virtual async Task<bool> CreateAsync(TRole role) {
            const string sql = "INSERT INTO AspNetRoles " +
        ...
        public virtual async Task<bool> UpdateAsync(TRole role, IList<TRoleClaim> claims = null) {
            const string updateRoleSql = "UPDATE AspNetRoles " +
            ...
            using (var transaction = DbConnection.BeginTransaction()) {
                ...
                if (claims?.Count() > 0) {
                    ...
                    const string insertClaimsSql = "INSERT INTO AspNetRoleClaims (RoleId, ClaimType, ClaimValue) " +
