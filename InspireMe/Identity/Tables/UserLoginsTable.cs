...
namespace InspireMe.Identitiy
{
        ...
        where TUserLogin : IdentityUserLogin<TKey>, new()
    {
        ...
        public UserLoginsTable(IDatabaseConnectionFactory dbConnectionFactory) : base(dbConnectionFactory) { }
        ...
        public virtual async Task<TUser> FindByLoginAsync(string loginProvider, string providerKey) {
            const string sql = "SELECT u.* FROM AspNetUsers AS u INNER JOIN AspNetUserLogins AS ul ON ul.UserId = u.Id WHERE ul.LoginProvider = @LoginProvider AND ul.ProviderKey = @ProviderKey;";
